...
namespace JuegoTaller.Migrations
{
    /// <inheritdoc />
    public partial class MiPrimeraMigrascion : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Nombre = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Pocición = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
